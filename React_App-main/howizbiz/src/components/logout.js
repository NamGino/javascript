        ...
        <>
            ...
            <Modal show={show} onHide={handleClose}>
                <div className='col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 d-flex flex-wrap'>
                    ...
                    <div className='col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 d-flex justify-content-center py-2'>{user && user.roles.map(item => <span className='mx-2 p-2' style={{ backgroundColor: item.meta.color, color: item.meta['text-color'], borderRadius: '5px' }}>{item.name}</span>)}</div>
                </div>
